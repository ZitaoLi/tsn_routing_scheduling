...
ROUTING_STRATEGY = Enum('ROUTING_STRATEGY', ('BACKTRACKING_REDUNDANT_ROUTING_STRATEGY', 'DIJKSTRA_SINGLE_ROUTING_STRATEGY'))
SCHEDULING_STRATEGY = Enum('SCHEDULING_STRATEGY', ('LRF_REDUNDANT_SCHEDULING_STRATEGY'))
